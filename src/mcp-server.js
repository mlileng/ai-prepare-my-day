...
server.tool(
  'sync_calendar',
  "Syncs today's calendar meetings to Notion and creates a daily page. Returns structured JSON with meeting counts and any errors. Safe to call multiple times — idempotent via content hash cache.",
  {}, // no input parameters
  async () => {
    const result = {
      meetings_found: 0,
